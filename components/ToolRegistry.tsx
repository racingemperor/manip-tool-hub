...
type FilterIconName = "all" | "docs" | "code" | "run" | "verified" | "paper" | "image" | "api" | "benchmark";
...
const readinessIcons: Record<string, FilterIconName> = {
  All: "all",
  "Docs Ready": "docs",
  "Code Linked": "code",
  Runnable: "run",
...
const resourceIcons: Record<string, FilterIconName> = {
  All: "all",
  Paper: "paper",
  "Demo images": "image",
  "API docs": "api",
...
function FilterMenuLabel({ icon, label }: { icon: FilterIconName; label: string }) {
  return (
...
export function ToolRegistry() {
  ...
  const statusOptions: CompactSelectOption[] = [
    { value: "All", label: "All readiness levels", count: tools.length },
    ...readinessOrder
    ...
    <>
      <div className="tool-controls">
        ...
        <CompactSelect
          ...
          renderOption={(item) => (
            <>
              <FilterMenuLabel icon={readinessIcons[item.value] ?? "all"} label={item.label} />
        ...
        <CompactSelect
          ...
          renderOption={(item) => (
            <>
              <FilterMenuLabel icon={resourceIcons[item.value] ?? "all"} label={item.label} />
              {typeof item.count === "number" ? <span className="compact-select-count">{item.count}</span> : null}
            </>
          )}
        />
